...
typedef enum {TR_ICMP6, TR_ICMP, TR_UDP6, TR_UDP,
              ...
              TR_TCP6_SYN_PSHACK, TR_TCP_PSHACK, TR_TCP6_PSHACK,
              TR_TCP_PSHACK_X2, TR_TCP6_PSHACK_X2} traceroute_type;

static const char *Tr_Type_String[] = {"ICMP6", "ICMP", "UDP6", "UDP",
              "TCP6_SYN", "TCP_SYN", "TCP6_ACK",
              "TCP_ACK", "ICMP_REPLY", "TCP_SYN_PSHACK", "TCP_PSHACK", "TCP_PSHACK_X2",
              "TCP6_SYN_PSHACK", "TCP6_PSHACK", "TCP6_PSHACK_X2"};
